...
# Base paths
# VENDORED for "CT.gov verified analysis": this file lives one level deeper than the
# original analysis dir, so PROJECT_ROOT goes up THREE levels to the TimeToxSV root
# (where results/ and Included Trials.csv live). Outputs stay under ANALYSIS_ROOT
# (this verified folder), isolating them from the original run.
